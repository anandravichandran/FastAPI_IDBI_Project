    ...
    async def complete(
        ...
        *,
        ...
        payload: dict[str, object] = {
            ...
            "stream": False,
            # NVIDIA's DeepSeek V4 models expose a "thinking" (extended
            # reasoning) toggle via chat_template_kwargs. This mirrors the
            # extra_body={"chat_template_kwargs": {"thinking": ...}} shape sent
            # by the official openai Python SDK.
